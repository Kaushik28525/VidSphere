...
const testUser = await User.findOne({ email: "k@us.com" }).select("-password");

console.log("DIRECT USER TEST:", testUser);
...
const getCurrentUser = asyncHandler(async(req, res) => {
    return res
    .status(200)
    .jason(new ApiResponse( 200, req.user, "current user fetched successfully"))
})
